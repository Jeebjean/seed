...
function accordions() {}
$(".accordions > li:eq(0) a").addClass("active").next().slideDown();

$(".accordions a").click(function (j) {
  var dropDown = $(this).closest("li").find("p");

  $(this).closest(".accordions").find("p").not(dropDown).slideUp();

  if ($(this).hasClass("active")) {
    $(this).removeClass("active");
  } else {
    $(this).closest(".accordions").find("a.active").removeClass("active");
    $(this).addClass("active");
  }
